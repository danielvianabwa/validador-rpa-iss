...
LISTA_SERVICOS_LC116_PADRAO = {
    ...
    "01.03 - Processamento, armazenamento ou hospedagem de dados, textos e imagens": {"aliquota": 0.02, "aceita_rpa": True},
    "01.04 - Elaboração de programas de computadores, inclusive de jogos eletrônicos": {"aliquota": 0.02, "aceita_rpa": True},
    "01.05 - Licenciamento ou cessão de direito de uso de programas de computação": {"aliquota": 0.02, "aceita_rpa": True},
    "01.06 - Assessoria e consultoria em informática": {"aliquota": 0.05, "aceita_rpa": True},
    "01.07 - Suporte técnico em informática, manutenção de software e páginas web": {"aliquota": 0.03, "aceita_rpa": True},
    "01.08 - Configuração, instalação e manutenção de redes de computadores": {"aliquota": 0.03, "aceita_rpa": True},
    ...
    "04.02 - Análises clínicas, patologia, eletrocardio, radiologia e exames": {"aliquota": 0.02, "aceita_rpa": True},
    "04.03 - Enfermagem, inclusive serviços de acompanhantes e cuidadores": {"aliquota": 0.02, "aceita_rpa": True},
    "04.06 - Fisioterapia, fonoaudiologia e terapia ocupacional": {"aliquota": 0.02, "aceita_rpa": True},
    "04.09 - Nutrição e dietética": {"aliquota": 0.02, "aceita_rpa": True},
    "04.11 - Odontologia e ortodontia": {"aliquota": 0.02, "aceita_rpa": True},
    "04.12 - Psicologia e psicanálise": {"aliquota": 0.02, "aceita_rpa": True},
    "04.16 - Atendimento e assistência médica domiciliar (Home Care)": {"aliquota": 0.02, "aceita_rpa": True},
    "05.01 - Medicina veterinária e zootecnia": {"aliquota": 0.03, "aceita_rpa": True},
    "06.01 - Barbearia, cabeleireiros, manicuros, pedicuros e esteticistas": {"aliquota": 0.03, "aceita_rpa": True},
    ...
    "08.01 - Ensino regular pré-escolar, fundamental, médio e superior": {"aliquota": 0.03, "aceita_rpa": True},
...
TABELA_SAO_PAULO.update({
    ...
    "01.04 - Elaboração de programas de computadores, inclusive de jogos eletrônicos": {"aliquota": 0.02, "aceita_rpa": False},
    "01.05 - Licenciamento ou cessão de direito de uso de programas de computação": {"aliquota": 0.02, "aceita_rpa": False},
    "01.06 - Assessoria e consultoria em informática": {"aliquota": 0.02, "aceita_rpa": False},
    "01.07 - Suporte técnico em informática, manutenção de software e páginas web": {"aliquota": 0.02, "aceita_rpa": False},
    "04.01 - Medicina e biomedicina": {"aliquota": 0.02, "aceita_rpa": False},
    "04.02 - Análises clínicas, patologia, eletrocardio, radiologia e exames": {"aliquota": 0.02, "aceita_rpa": False},
    "04.03 - Enfermagem, inclusive serviços de acompanhantes e cuidadores": {"aliquota": 0.02, "aceita_rpa": False},
...
TABELA_BELO_HORIZONTE.update({
    ...
    "04.01 - Medicina e biomedicina": {"aliquota": 0.03, "aceita_rpa": True},
    "04.02 - Análises clínicas, patologia, eletrocardio, radiologia e exames": {"aliquota": 0.03, "aceita_rpa": True},
    "07.01 - Engenharia, agronomia, agrimensura, arquitetura, geologia e urbanismo": {"aliquota": 0.05, "aceita_rpa": True},
    "17.01 - Assessoria ou consultoria de qualquer natureza": {"aliquota": 0.05, "aceita_rpa": True},
})
...
class MotorTributarioISS:
    ...
    def analisar(self, rpa: RPAData) -> dict:
        ...
        if not info_servico_tomador.get("aceita_rpa", True):
            return {
                "status": "REJEITADO",
                "motivo_rejeicao": f"O município de {mun_tomador} proíbe a emissão de RPA para o serviço informado. É obrigatória a emissão de Nota Fiscal Eletrônica de Serviços (NFS-e).",
                "deve_reter": False,
                "aliquota": 0.0,
                "valor_iss": 0.0,
        ...
        return {
            ...
            "aliquota_percentual": f"{aliquota * 100:.2f}%" if deve_reter else f"{aliquota * 100:.2f}% (Isento de Retenção na Fonte)",
            "valor_iss": valor_iss,
            "inss": inss,
            "irrf": irrf,
...
with tabs[0]:
    ...
    with col2:
        ...
        opcoes_servicos = ["-- Selecione o Código do Serviço --"] + list(LISTA_SERVICOS_LC116_PADRAO.keys())
